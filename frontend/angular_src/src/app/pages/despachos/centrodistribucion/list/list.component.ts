...
export class DespachosCentrodistribucionListComponent implements OnInit {
  ...
  public loadDespachosList()
  {
    ...
    this._despachosService.getDespachos_centrodistribucion(this.centrodistribucion_id)
    .subscribe(
      //Success request
      (response: any) => {
  ...
  public removeDespacho(despacho: any)
  {
    Swal.fire({
      ...
      if(result.isConfirmed)
      {
        ...
        this._despachosService.removeDespacho_centrodistribucion(this.centrodistribucion_id, despacho.id)
        .subscribe(
          //Success request
          (response: any) => {
  ...
  public goTo_newDespacho(): void {
    this.router.navigate(['/panel/despachos/centrodistribucion/create']);
  }
}
