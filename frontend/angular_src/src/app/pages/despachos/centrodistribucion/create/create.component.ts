...
export class DespachosCentrodistribucionCreateComponent implements OnInit {
      ...
      (response: any) => {
        ...
        else
        {
          NotificationsService.showToast(
            'No se encontraron sucursales con partes pendiente de despacho',
  ...
  public loadOcPartes(): void {
    ...
    this._despachosService.queueOcPartesDespacho_centrodistribucion(this.centrodistribucion_id, this.despachoForm.value.sucursal)
    .subscribe(
      //Success request
      (response: any) => {
        ...
        else
        {
          NotificationsService.showAlert(
            'No se encontraron partes para despachar a la sucursal seleccionada',
            NotificationsService.messageType.info
          );
        }
