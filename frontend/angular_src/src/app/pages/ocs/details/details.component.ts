        ...
        this.partes.push(
          {
            ...
            'cantidad_pendiente': p.pivot.cantidad_pendiente,
            'cantidad_compradorrecepcionado': p.pivot.cantidad_compradorrecepcionado,
            'cantidad_compradordespachado': p.pivot.cantidad_compradordespachado,
            'cantidad_centrodistribucionrecepcionado': p.pivot.cantidad_centrodistribucionrecepcionado,
            'cantidad_centrodistribuciondespachado': p.pivot.cantidad_centrodistribuciondespachado,
            'cantidad_sucursalrecepcionado': p.pivot.cantidad_sucursalrecepcionado,
            'cantidad_sucursaldespachado': p.pivot.cantidad_sucursaldespachado,
