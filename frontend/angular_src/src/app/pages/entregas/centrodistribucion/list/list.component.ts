...
export class EntregasCentrodistribucionListComponent implements OnInit {
  ...
  public loadEntregasList()
  {
    ...
    this._entregasService.getEntregas_centrodistribucion(this.centrodistribucion_id)
    .subscribe(
      //Success request
      (response: any) => {
  ...
  public removeEntrega(entrega: any)
  {
    Swal.fire({
      ...
      if(result.isConfirmed)
      {
        ...
        this._entregasService.removeEntrega_centrodistribucion(this.centrodistribucion_id, entrega.id)
        .subscribe(
          //Success request
          (response: any) => {
  ...
  public goTo_newEntrega(): void {
    this.router.navigate(['/panel/entregas/centrodistribucion/create']);
  }
