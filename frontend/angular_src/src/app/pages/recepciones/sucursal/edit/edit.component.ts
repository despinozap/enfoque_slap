...
export class RecepcionesSucursalEditComponent implements OnInit {
  ...
  public loadRecepcion(): void {
    ...
    this._recepcionesService.prepareUpdateRecepcion_sucursal(this.sucursal_id, this.recepcion.id)
    .subscribe(
      //Success request
      (response: any) => {
