...
export class RecepcionesCentrodistribucionListComponent implements OnInit {
  ...
  public loadRecepcionesList()
  {
    ...
    this._recepcionesService.getRecepciones_centrodistribucion(this.centrodistribucion_id)
    .subscribe(
      //Success request
      (response: any) => {
  ...
  public removeRecepcion(recepcion: any)
  {
    Swal.fire({
      ...
      if(result.isConfirmed)
      {
        ...
        this._recepcionesService.removeRecepcion_centrodistribucion(this.centrodistribucion_id, recepcion.id)
        .subscribe(
          //Success request
          (response: any) => {
  ...
  public goTo_newRecepcion(): void {
    this.router.navigate(['/panel/recepciones/centrodistribucion/create']);
  }
