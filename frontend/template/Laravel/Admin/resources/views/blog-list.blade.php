                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            <ul class="list-inline">
                                                ...
                                                <li class="list-inline-item mr-3">
                                                    <a href="#" class="text-muted">
                                                        <i class="bx bx-comment-dots align-middle text-muted mr-1"></i> 12
                                                        Comments
                                                    </a>
                                                </li>
                                            </ul>
                                        ...
                                        <div>
                                            ...
                                            <ul class="list-inline">
                                                ...
                                                <li class="list-inline-item mr-3">
                                                    <a href="#" class="text-muted">
                                                        <i class="bx bx-comment-dots align-middle text-muted mr-1"></i> 08
                                                        Comments
                                                    </a>
                                                </li>
                                            </ul>
                                ...
                                <div class="col-xl  -8">
                                    ...
                                    <div class="mt-5">
                                        ...
                                        <div class="list-group list-group-flush">
                                            ...
                                            <a href="blog-details" class="list-group-item text-muted"><i
                                                    class="mdi mdi-circle-medium mr-1"></i> Project discussion with team</a>
            ...
            <div class="card">
                <div class="card-body p-4">
                    ...
                    <div>
                        ...
                        <ul class="list-unstyled font-weight-medium">
                            <li><a href="#" class="text-muted py-2 d-block"><i class="mdi mdi-chevron-right mr-1"></i> 2020
                                    <span
                                        class="badge badge-soft-success badge-pill float-right ml-1 font-size-12">03</span></a>
                            </li>
                            <li><a href="#" class="text-muted py-2 d-block"><i class="mdi mdi-chevron-right mr-1"></i> 2019
                                    <span
                                        class="badge badge-soft-success badge-pill float-right ml-1 font-size-12">06</span></a>
                            </li>
                            <li><a href="#" class="text-muted py-2 d-block"><i class="mdi mdi-chevron-right mr-1"></i> 2018
                                    <span
                    ...
                    <div>
                        ...
                        <ul class="list-inline widget-tag">
                            <li class="list-inline-item"><a href="#" class="badge badge-light font-size-12 mt-2">Design</a>
                            </li>
                            <li class="list-inline-item"><a href="#"
                                    class="badge badge-light font-size-12 mt-2">Development</a></li>
                            <li class="list-inline-item"><a href="#"
                                    class="badge badge-light font-size-12 mt-2">Business</a></li>
                            <li class="list-inline-item"><a href="#" class="badge badge-light font-size-12 mt-2">Project</a>
                            </li>
                            <li class="list-inline-item"><a href="#" class="badge badge-light font-size-12 mt-2">Travel</a>
                            </li>
                            <li class="list-inline-item"><a href="#"
