            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div>
                                <a href="invoices-detail" class="d-block text-primary mb-2">Invoice #14251</a>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div>
                                <a href="invoices-detail" class="d-block mb-2">Invoice #14252</a>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div>
                                <a href="invoices-detail" class="d-block mb-2">Invoice #14253</a>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div>
                                <a href="invoices-detail" class="d-block text-primary mb-2">Invoice #14254</a>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div>
                                <a href="invoices-detail" class="d-block mb-2">Invoice #14255</a>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div>
                                <a href="invoices-detail" class="d-block mb-2">Invoice #14256</a>
                                <h5 class="text-truncate mb-4 mb-lg-5">Landing page Design</h5>
                                <ul class="list-inline mb-0">
                                    <li class="list-inline-item mr-3">
                                        <h5 class="font-size-14" data-toggle="tooltip" data-placement="top" title="Amount">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div>
                                <a href="invoices-detail" class="d-block text-primary mb-2">Invoice #14257</a>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div>
                                <a href="invoices-detail" class="d-block mb-2">Invoice #14258</a>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            <div>
                                <a href="invoices-detail" class="d-block mb-2">Invoice #14259</a>
