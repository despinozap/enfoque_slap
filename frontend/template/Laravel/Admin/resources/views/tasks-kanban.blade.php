                                ...
                                <div class="card-body">
                                    ...
                                    <div class="team float-left cd-assigne">
                                        <a href="javascript: void(0);" class="team-member d-inline-block" value="member-4">
                                            <img src="{{ URL::asset('/assets/images/users/avatar-4.jpg') }}" class="rounded-circle avatar-xs m-1"
                                                alt="">
                                        </a>

                                        <a href="javascript: void(0);" class="team-member d-inline-block" value="member-5">
                                            <img src="{{ URL::asset('/assets/images/users/avatar-5.jpg') }}" class="rounded-circle avatar-xs m-1"
                                                alt="">
                                        </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="team float-left cd-assigne">
                                        <a href="javascript: void(0);" class="team-member d-inline-block" value="member-6">
                                            <img src="{{ URL::asset('/assets/images/users/avatar-6.jpg') }}" class="rounded-circle avatar-xs m-1"
                                                alt="" id="team-member-1">
                                        </a>

                                        <a href="javascript: void(0);" class="team-member d-inline-block" value="member-7">
                                            <img src="{{ URL::asset('/assets/images/users/avatar-7.jpg') }}" class="rounded-circle avatar-xs m-1"
                                                alt="">
                                        </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="team float-left cd-assigne">
                                        ...
                                        <a href="javascript: void(0);" class="team-member d-inline-block" value="member-3">
                                            <img src="{{ URL::asset('/assets/images/users/avatar-3.jpg') }}" class="rounded-circle avatar-xs m-1"
                                                alt="">
                                        </a>
                                    </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="team float-left cd-assigne">
                                        <a href="javascript: void(0);" class="team-member d-inline-block" value="member-8">
                                            <img src="{{ URL::asset('/assets/images/users/avatar-8.jpg') }}" class="rounded-circle avatar-xs m-1"
                                                alt="">
                                        </a>
                                        <a href="javascript: void(0);" class="team-member d-inline-block" value="member-5">
                                            <img src="{{ URL::asset('/assets/images/users/avatar-5.jpg') }}" class="rounded-circle avatar-xs m-1"
                                        ...
                                        <a href="javascript: void(0);" class="team-member d-inline-block" value="member-1">
                                            <img src="{{ URL::asset('/assets/images/users/avatar-1.jpg') }}" class="rounded-circle avatar-xs m-1"
                                                alt="">
                                        </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="team float-left cd-assigne">
                                        <a href="javascript: void(0);" class="team-member d-inline-block" value="member-2">
                                            <img src="{{ URL::asset('/assets/images/users/avatar-2.jpg') }}" class="rounded-circle avatar-xs m-1"
                                                alt="">
                                        </a>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-inline mb-4">
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div>
                                                    <img src="{{ URL::asset('/assets/images/small/img-1.jpg') }}" class="rounded" alt=""
                                                        height="48">
                                                </div>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div>
                                                    <img src="{{ URL::asset('/assets/images/small/img-2.jpg') }}" class="rounded" alt=""
                                                        height="48">
                                                </div>
                                            </a>
                                        </li>
                                        <li class="list-inline-item">
                                            <a href="#">
                                                <div>
                                                    <img src="{{ URL::asset('/assets/images/small/img-3.jpg') }}" class="rounded" alt=""
                                                        height="48">
                                                </div>
                                            </a>
                                        </li>
