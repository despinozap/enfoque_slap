            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="media">
                        ...
                        <img class="d-flex ml-3 rounded-circle" src="{{ URL::asset('/assets/images/users/avatar-4.jpg') }}"
                            alt="Generic placeholder image" height="64">
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="media mb-4">
                        <img class="d-flex align-self-center rounded mr-3"
                            src="{{ URL::asset('/assets/images/users/avatar-5.jpg') }}" alt="Generic placeholder image"
                            height="64">
                        <div class="media-body">
                    ...
                    <div class="media">
                        <img class="d-flex align-self-end rounded mr-3"
                            src="{{ URL::asset('/assets/images/users/avatar-1.jpg') }}" alt="Generic placeholder image"
                            height="64">
                        <div class="media-body">
