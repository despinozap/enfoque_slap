                        ...
                        <div class="col-lg-4">
                            <div class="mt-4">
                                ...
                                <h5>12356 <span class="text-success font-size-13">0.2 % <i
                                            class="mdi mdi-arrow-up ml-1"></i></span></h5>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="dropdown ml-auto">
                            <a class="text-muted dropdown-toggle font-size-16" role="button" data-toggle="dropdown"
                                aria-haspopup="true">
            ...
            <div class="card">
                <div class="card-header bg-transparent border-bottom">
                    <div class="d-flex flex-wrap">
                        ...
                        <ul class="nav nav-tabs nav-tabs-custom card-header-tabs ml-auto" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#post-recent" role="tab">
                                    Recent
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#post-popular" role="tab">
                                    Popular
                                </a>
                            </li>
                        </ul>
                        ...
                        <ul class="list-group list-group-flush">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <div>
                                            <a href="javascript: void(0);" class="text-success"><i
                                                    class="mdi mdi-reply mr-1"></i> Reply</a>
                                        </div>
                                    </div>
                                </div>
                            </li>
                            ...
                            <li class="list-group-item py-3">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="font-size-14 mb-1">Clarence Smith <small class="text-muted float-right">2
                                                hrs Ago</small></h5>
                            ...
                            <li class="list-group-item py-3">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <h5 class="font-size-14 mb-1">Keith McCoy <small class="text-muted float-right">12
                                                Aug</small></h5>
                    ...
                    <div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item">
                                <div class="py-2">
                                    <h5 class="font-size-14">California <span class="float-right">78%</span></h5>
                            ...
                            <li class="list-group-item">
                                <div class="py-2">
                                    <h5 class="font-size-14">Nevada <span class="float-right">69%</span></h5>
                                    <div class="progress animated-progess progress-sm">
                            ...
                            <li class="list-group-item">
                                <div class="py-2">
                                    <h5 class="font-size-14">Texas <span class="float-right">61%</span></h5>
                                    <div class="progress animated-progess progress-sm">
                        ...
                        <table class="table table-centered table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><i class="bx bx-like align-middle mr-1"></i> 125</td>
                                    <td><i class="bx bx-comment-dots align-middle mr-1"></i> 68</td>
                                    <td>
                                        <div class="dropdown">
                                ...
                                <tr>
                                    ...
                                    <td><i class="bx bx-like align-middle mr-1"></i> 102</td>
                                    <td><i class="bx bx-comment-dots align-middle mr-1"></i> 48</td>
                                    <td>
                                        <div class="dropdown">
                                            <a class="text-muted dropdown-toggle font-size-16" role="button"
                                                data-toggle="dropdown" aria-haspopup="true">
                                ...
                                <tr>
                                    ...
                                    <td><i class="bx bx-like align-middle mr-1"></i> 98</td>
                                    <td><i class="bx bx-comment-dots align-middle mr-1"></i> 35</td>
                                    <td>
                                        <div class="dropdown">
                                            <a class="text-muted dropdown-toggle font-size-16" role="button"
                                                data-toggle="dropdown" aria-haspopup="true">
                                ...
                                <tr>
                                    ...
                                    <td><i class="bx bx-like align-middle mr-1"></i> 92</td>
                                    <td><i class="bx bx-comment-dots align-middle mr-1"></i> 22</td>
                                    <td>
                                        <div class="dropdown">
                                            <a class="text-muted dropdown-toggle font-size-16" role="button"
                                                data-toggle="dropdown" aria-haspopup="true">
