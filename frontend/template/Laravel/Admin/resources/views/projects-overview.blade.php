    ...
    <div class="row">
        <div class="col-lg-8">
            <div class="card">
                <div class="card-body">
                    <div class="media">
                        <img src="{{ URL::asset('/assets/images/companies/img-1.png') }}" alt="" class="avatar-sm mr-4">
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-nowrap">
                            <tbody>
                                ...
                                <tr>
                                    <td><img src="{{ URL::asset('/assets/images/users/avatar-1.jpg') }}" class="rounded-circle avatar-xs" alt="">
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    <td><img src="{{ URL::asset('/assets/images/users/avatar-4.jpg') }}" class="rounded-circle avatar-xs" alt="">
                                    </td>
                                    <td>
