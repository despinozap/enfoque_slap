            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="mt-4">
                                <h5 class="font-size-14">With Label</h5>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="inputGroupFileAddonwithlabel">Upload</span>
                                    </div>
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="inputGroupFilwithlabel" aria-describedby="inputGroupFileAddonwithlabel">
                                        <label class="custom-file-label" for="inputGroupFilwithlabel">Choose file</label>
                                    </div>
                                </div>
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="file" class="custom-file-input" id="inputGroupFilewithlabelicon01">
                                        <label class="custom-file-label" for="inputGroupFilewithlabelicon01" aria-describedby="inputGroupFileAddonwithlabelicon01">Choose file</label>
                                    </div>
                        ...
                        <div class="col-sm-6">
                            <div class="mt-4">
                                <h5 class="font-size-14">With Button</h5>
