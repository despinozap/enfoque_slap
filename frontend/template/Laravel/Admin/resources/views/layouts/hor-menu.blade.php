                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-dashboard">
                            ...
                            <a href="dashboard-blog" class="dropdown-item">@lang('translation.Blog')</a>
                        </div>
                    </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            ...
                            <a href="apps-filemanager" class="dropdown-item">@lang('translation.File_Manager')</a>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-email">
                                    ...
                                    <div class="dropdown">
                                        <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-blog"
                                            role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            @lang('translation.Templates')<div class="arrow-down"></div>
                                        </a>
                                        <div class="dropdown-menu" aria-labelledby="topnav-blog">
                                            <a href="email-template-basic" class="dropdown-item">@lang('translation.Basic_Action')</a>
                            ...
                            <div class="dropdown">
                                <a class="dropdown-item dropdown-toggle arrow-none" href="#" id="topnav-blog"
                                    role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    @lang('translation.Blog') <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-blog">
                                    <a href="blog-list" class="dropdown-item">@lang('translation.Blog_List')</a>
                                    <a href="blog-grid" class="dropdown-item">@lang('translation.Blog_Grid')</a>
                                    <a href="blog-details" class="dropdown-item">@lang('translation.Blog_Details')</a>
                                </div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-more">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                    ...
                                    <a href="auth-login-2" class="dropdown-item">@lang('translation.Login') 2</a>
                                    <a href="auth-register" class="dropdown-item">@lang('translation.Register')</a>
                                    <a href="auth-register-2" class="dropdown-item">@lang('translation.Register') 2</a>
                                    <a href="auth-recoverpw"
                                        class="dropdown-item">@lang('translation.Recover_Password')</a>
                                        <a href="auth-recoverpw-2"
                                        class="dropdown-item">@lang('translation.Recover_Password') 2</a>
                                    <a href="auth-lock-screen"
                                        class="dropdown-item">@lang('translation.Lock_screen')</a>
                                    <a href="auth-lock-screen-2"
                                        class="dropdown-item">@lang('translation.Lock_screen') 2</a>
                                    <a href="auth-confirm-mail" class="dropdown-item">@lang('translation.Confirm_Mail')</a>
                                    <a href="auth-confirm-mail-2" class="dropdown-item">@lang('translation.Confirm_Mail') 2</a>
                                    <a href="auth-email-verification" class="dropdown-item">@lang('translation.Email_verification')</a>
                                    <a href="auth-email-verification-2" class="dropdown-item">@lang('translation.Email_verification') 2</a>
                                    <a href="auth-two-step-verification" class="dropdown-item">@lang('translation.Two_step_verification')</a>
                                    <a href="auth-two-step-verification-2" class="dropdown-item">@lang('translation.Two_step_verification') 2</a>
                                </div>
                            </div>
                            <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-layout">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-layout-hori">
                                    ...
                                    <a href="layouts-hori-topbar-light" class="dropdown-item">@lang('translation.Topbar_Light')</a>
                                    ...
                                    <a href="layouts-hori-colored-header" class="dropdown-item">@lang('translation.Colored_Topbar')</a>
                                    <a href="layouts-hori-scrollable" class="dropdown-item">@lang('translation.Scrollable')</a>
                                </div>
                            </div>
                        </div>
                    </li>
